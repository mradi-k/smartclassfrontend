  ...
  const loadstdData = () => {
    ...
    fetch(
      "http://localhost:4000/api/v1/student/" +
        localStorage.getItem("std_userId"),
      requestOptions
    )
        ...
        <div style={{ width: "50vw", display: "flex", gap: "20px" }}>
          <div style={{ width: "50%" }}>
            <div className="form-group">
              ...
              />
              {errors && (
                <div style={{ position: "relative" }}>{errors.name}</div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors && (
                <div style={{ position: "relative" }}>{errors.email}</div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors && (
                <div style={{ position: "relative" }}>{errors.phone}</div>
              )}
            </div>
          ...
          <div style={{ width: "50%" }}>
            ...
            <div className="form-group">
              ...
              />
              {errors && (
                <div style={{ position: "relative" }}>{errors.fatherName}</div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors && (
                <div style={{ position: "relative" }}>{errors.password}</div>
              )}
            </div>
